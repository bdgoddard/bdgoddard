...
![]({{ site.url }}{{ site.baseurl }}/images/Colloids.png){: style="width: 400px; float: right; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/Photodissociation.png){: style="width: 400px; float: left; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/CSpectrum.png){: style="width: 400px; float: right; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/RNATranscription.png){: style="width: 400px; float: left; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/PDECO.png){: style="width: 400px; float: right; border: 10px"}
